...
def add_to_watchlist(user_id, film_id, public=False):
    ...
    Args:
        ...
        public (bool, optional): Whether the entry is publicly visible.
            Defaults to False (private) — callers opt in to sharing explicitly.
...
def get_watchlist(user_id):
    ...
    Ordering mirrors get_collection() for a consistent experience across the
    two list views (see Comment 5 in the PR review).
